...
def test_clean_company_name():
    ...
    assert clean_company_name("A & A Auto Parts, Inc.") == "A & A Auto Parts"
    assert clean_company_name("A & A Auto Parts, Inc. ") == "A & A Auto Parts"
    assert clean_company_name("Satellite Healthcare / WellBound") == "Satellite"
    ...
    assert clean_company_name("HEAL Security | Cognitive Cybersecurity Intelligence for the Healthcare Sector") == "HEAL"

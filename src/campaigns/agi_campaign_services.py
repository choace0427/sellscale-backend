...
def create_agi_campaign(client_sdr_id: int, query: str):
    """
    ...
    # import all contacts directly into campaign and into the segment
    ...
    top_sequences = db.session.execute(top_sequences_query.format(client_id)).fetchall()

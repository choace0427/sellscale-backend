...
def get_personas_page_campaigns(client_sdr_id: int) -> dict:
    ...
    results = db.session.execute(
        ...
        SELECT
            ...
            count(DISTINCT prospect.id) FILTER (WHERE prospect.email != NULL) "EMAIL-ELIGIBLE",
            ...
            count(DISTINCT prospect.id) FILTER (WHERE prospect.linkedin_url != NULL) "LINKEDIN-ELIGIBLE",

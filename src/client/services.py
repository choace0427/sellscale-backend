...
def get_personas_page_campaigns(client_sdr_id: int) -> dict:
    ...
    results = db.session.execute(
        ...
        SELECT
            ...
            count(DISTINCT prospect.id) FILTER (WHERE prospect.approved_outreach_message_id IS NOT NULL and prospect.overall_status not in ('PROSPECTED', 'SENT_OUTREACH')) "TOTAL-PROSPECTS-LEFT-LINKEDIN",
            count(DISTINCT prospect.id) FILTER (WHERE prospect.approved_prospect_email_id IS NOT NULL and prospect.overall_status not in ('PROSPECTED', 'SENT_OUTREACH')) "TOTAL-PROSPECTS-LEFT-EMAIL",
    ...
    column_map = {
        ...
        22: "total_opened",
        23: "total_replied",
        24: "total_pos_replied",
        25: "total_demo",
        26: "total_prospects",
        27: "total_prospects_left_linkedin",
        28: "total_prospects_left_email",
        29: "smartlead_campaign_id",
        30: "meta_data",
        31: "first_message_delay_days",
    }

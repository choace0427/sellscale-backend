...
def get_personas_page_campaigns(client_sdr_id: int) -> dict:
    ...
    results = db.session.execute(
        ...
        SELECT
            ...
            count(DISTINCT prospect.id) FILTER (WHERE prospect_email_status_records.to_status is not NULL) "EMAIL-USED",
            ...
            count(DISTINCT prospect.id) FILTER (WHERE prospect_status_records.to_status not in ('QUEUED_FOR_OUTREACH')) "LI-USED",
    ...
    column_map = {
        ...
        8: "sdr_id",
        9: "email_eligible",
        10: "email_used",  # This Query above may need reworking to match the logic for li_used
        11: "email_sent",
        12: "email_opened",
        13: "email_replied",
        14: "email_demo",
        ...
        27: "total_opened",
        28: "total_replied",
        29: "total_pos_replied",
        30: "total_demo",
        31: "total_prospects",
        32: "total_prospects_left_linkedin",
        33: "total_prospects_left_email",
        34: "total_used",
        35: "smartlead_campaign_id",
        36: "meta_data",
        37: "first_message_delay_days",
    }

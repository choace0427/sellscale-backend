...
def collect_and_generate_email_messaging_schedule_entries() -> tuple[bool, str]:
    ...
    success, message = generate_email_messaging_schedule_entry(
...
def generate_email_messaging_schedule_entry(
    ...
    prospect_email: ProspectEmail = ProspectEmail.query.get(email_messaging_schedule.prospect_email_id)
    ...
    subject_line: GeneratedMessage = GeneratedMessage.query.get(last_messaging_schedule.subject_line_id)

...
def generate_simple_summary(prompt):
    prompt_frame = """
prompt: Holiday gift guide Celebrate the joy of the season with amazing tech gifts. Shop and ship early for holiday delivery. Holiday gift guide Celebrate the joy of the season with amazing tech gifts. Shop and ship early for holiday delivery. Shop
...
summary: I saw your website and saw the server buying guide.XXX
...
""".format(
    ...
    completion = get_basic_openai_completion(prompt_frame, max_tokens=18)
    return completion

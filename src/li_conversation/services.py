...
def send_autogenerated_bumps():
    ...
    for sdr in autobumpable_sdrs:
        ...
        if prospect is None or (prospect.li_last_message_from_sdr is not None and sdr.disable_ai_on_message_send) or (prospect.li_last_message_from_prospect is not None and sdr.disable_ai_on_prospect_respond):
            continue

...
def send_autogenerated_bump(
    ...
    bump_delay_seconds = bump.bump_delay_days * 60 * 60 if bump.bump_delay_days else 48 * 60 * 60
    ...
    send_to_purgatory(prospect_id, bump_delay_days, ProspectHiddenReason.RECENTLY_BUMPED)

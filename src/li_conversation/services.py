...
def send_autogenerated_bump(
    ...
    """
    from src.message_generation.services import add_generated_msg_queue, process_generated_msg_queue
    ...
    # 10. Refetch conversation to update statuses, then process generated message queue
    convo, _ = fetch_conversation(api, prospect_id, True)

                  ...
                  <div style="max-width:760px;min-width:600px;margin:auto;margin-bottom:60px;text-align:center">
                    <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="justify-content:space-between;background-color:black;padding:15px 40px 15px 40px;border-radius:6px;width:100%">
                      <tbody style="width:100%">
                        <tr style="width:100%">
                          <td data-id="__react-email-column" style="text-align:center"><img src="https://www.aitoolsclub.com/content/images/2023/06/Screenshot-2023-06-28-151838.png" width="150px" style="background:black" /></td>
                    ...
                    <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="border:2px solid #efedf1;border-radius:6px;width:100%;margin-top:12px;padding:20px 34px 40px">
                      <tbody>
                        <tr>
                          <td>
                            <p style="font-size:16px;line-height:24px;margin:16px 0;color:gray;font-weight:500;text-align:start">You have <b>{num_tasks} new tasks</b> to complete.</p>
                                  ...
                                  <tbody style="width:100%">
                                    <tr style="width:100%">
                                      ...
                                      <td data-id="__react-email-column" style="width:100%;text-align:start;padding-left:20px">
                                        ...
                                        <span style="max-width:100%;display:inline-block;line-height:120%;mso-padding-alt:0px;mso-text-raise:7.5px"><div style="display:flex;align-items:center"><p style="font-size:14px;line-height:24px;margin:0px">Let's do it</p></span></a>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                            ...
                            <tr>
                              <td>
                                <div style="border:2px solid #edebef;border-style:dashed;border-radius:8px;padding:20px 40px">
                                  <p style="font-size:16px;line-height:24px;margin:16px 0;text-align:center; color: gray;"><b>⚠️ Important ⚠️: </b>Do not forward this email to others as they will be able to log in to your SellScale account</p>
                                </div>
                              </td>
                            </tr>
                          </tbody>

"""Autogen - Added ACTIVE_CONVO_OBJECTION to enum column status in table prospect

Revision ID: 5b692e85658a
Revises: 538315ff9da4
Create Date: 2023-04-21 12:40:11.748730
...
revision = '5b692e85658a'
down_revision = '538315ff9da4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    values.append('ACTIVE_CONVO_OBJECTION')
    op.execute("ALTER TYPE %s ADD VALUE '%s'" % (enum_type_name, 'ACTIVE_CONVO_OBJECTION'))
    pass
...
def downgrade():
    ...
    op.execute("ALTER TYPE %s DROP VALUE 'ACTIVE_CONVO_OBJECTION'" % enum_type_name)
    pass

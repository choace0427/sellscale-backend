"""Autogen - Added ACTIVE_CONVO_NEXT_STEPS to enum column status in table prospect

Revision ID: 33039437d263
Revises: 14ce784db10a
Create Date: 2023-04-24 18:37:06.347299
...
revision = '33039437d263'
down_revision = '14ce784db10a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    values.append('ACTIVE_CONVO_NEXT_STEPS')
    op.execute("ALTER TYPE %s ADD VALUE '%s'" % (enum_type_name, 'ACTIVE_CONVO_NEXT_STEPS'))
    pass
...
def downgrade():
    ...
    op.execute("ALTER TYPE %s DROP VALUE 'ACTIVE_CONVO_NEXT_STEPS'" % enum_type_name)
    pass
